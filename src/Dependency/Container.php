...
class Container extends FusioContainer
{
    ...
    public function getCustomerService(): Service\Customer
    {
        return new Service\Customer(
            $this->get('customer_repository'),
            $this->get('engine_dispatcher')
        );
    }
    ...
    public function getCustomerRepository(): Repository\Customer
    {
        return new Repository\Customer(
            $this->get('connector')->getConnection('caw_bentong')
        );
    }
}
